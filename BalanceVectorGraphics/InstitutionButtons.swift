...
public class InstitutionButtons : NSObject {
    ...
    public dynamic class func drawTdButton(bounds: NSRect = NSRect(x: 0, y: 0, width: 191, height: 56), original: Bool = true, hover: Bool = false, pressed: Bool = false) {
        ...
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 81.84, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 81.84, y: bounds.maxY - 25.68))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 84.81, y: bounds.maxY - 25.68))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 84.81, y: bounds.maxY - 26.69))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 87, y: bounds.maxY - 25.5), controlPoint1: NSPoint(x: bounds.minX + 85.34, y: bounds.maxY - 25.84), controlPoint2: NSPoint(x: bounds.minX + 86.1, y: bounds.maxY - 25.5))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 89.16, y: bounds.maxY - 26.6), controlPoint1: NSPoint(x: bounds.minX + 87.88, y: bounds.maxY - 25.5), controlPoint2: NSPoint(x: bounds.minX + 88.69, y: bounds.maxY - 25.68))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 91.7, y: bounds.maxY - 25.5), controlPoint1: NSPoint(x: bounds.minX + 89.77, y: bounds.maxY - 25.62), controlPoint2: NSPoint(x: bounds.minX + 90.68, y: bounds.maxY - 25.44))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 93.59, y: bounds.maxY - 27.54), controlPoint1: NSPoint(x: bounds.minX + 92.92, y: bounds.maxY - 25.59), controlPoint2: NSPoint(x: bounds.minX + 93.56, y: bounds.maxY - 26.23))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 93.62, y: bounds.maxY - 31.72), controlPoint1: NSPoint(x: bounds.minX + 93.62, y: bounds.maxY - 28.94), controlPoint2: NSPoint(x: bounds.minX + 93.62, y: bounds.maxY - 30.31))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 93.62, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 90.44, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 90.44, y: bounds.maxY - 32.08))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 90.44, y: bounds.maxY - 28.58))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 90.44, y: bounds.maxY - 28.24))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 89.86, y: bounds.maxY - 27.6), controlPoint1: NSPoint(x: bounds.minX + 90.41, y: bounds.maxY - 27.82), controlPoint2: NSPoint(x: bounds.minX + 90.21, y: bounds.maxY - 27.6))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 89.33, y: bounds.maxY - 28.27), controlPoint1: NSPoint(x: bounds.minX + 89.54, y: bounds.maxY - 27.63), controlPoint2: NSPoint(x: bounds.minX + 89.33, y: bounds.maxY - 27.82))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 89.33, y: bounds.maxY - 31.99))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 89.33, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 86.16, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 86.16, y: bounds.maxY - 32.08))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 86.16, y: bounds.maxY - 28.7))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 86.13, y: bounds.maxY - 28.12), controlPoint1: NSPoint(x: bounds.minX + 86.16, y: bounds.maxY - 28.52), controlPoint2: NSPoint(x: bounds.minX + 86.16, y: bounds.maxY - 28.3))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 85.6, y: bounds.maxY - 27.6), controlPoint1: NSPoint(x: bounds.minX + 86.1, y: bounds.maxY - 27.79), controlPoint2: NSPoint(x: bounds.minX + 85.92, y: bounds.maxY - 27.6))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 85.05, y: bounds.maxY - 28.12), controlPoint1: NSPoint(x: bounds.minX + 85.28, y: bounds.maxY - 27.6), controlPoint2: NSPoint(x: bounds.minX + 85.11, y: bounds.maxY - 27.79))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 85.02, y: bounds.maxY - 28.67), controlPoint1: NSPoint(x: bounds.minX + 85.02, y: bounds.maxY - 28.3), controlPoint2: NSPoint(x: bounds.minX + 85.02, y: bounds.maxY - 28.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 85.02, y: bounds.maxY - 32.51))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 81.84, y: bounds.maxY - 32.48), controlPoint1: NSPoint(x: bounds.minX + 83.94, y: bounds.maxY - 32.48), controlPoint2: NSPoint(x: bounds.minX + 82.89, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 81.84, y: bounds.maxY - 32.48))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 81.84, y: bounds.maxY - 32.48))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 69.88, y: bounds.maxY - 32.59))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 70.96, y: bounds.maxY - 29.42), controlPoint1: NSPoint(x: bounds.minX + 70.26, y: bounds.maxY - 31.49), controlPoint2: NSPoint(x: bounds.minX + 70.61, y: bounds.maxY - 30.46))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 72.89, y: bounds.maxY - 23.69), controlPoint1: NSPoint(x: bounds.minX + 71.6, y: bounds.maxY - 27.5), controlPoint2: NSPoint(x: bounds.minX + 72.25, y: bounds.maxY - 25.61))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 73.33, y: bounds.maxY - 23.36), controlPoint1: NSPoint(x: bounds.minX + 72.98, y: bounds.maxY - 23.45), controlPoint2: NSPoint(x: bounds.minX + 73.06, y: bounds.maxY - 23.36))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 77.67, y: bounds.maxY - 23.36), controlPoint1: NSPoint(x: bounds.minX + 74.75, y: bounds.maxY - 23.39), controlPoint2: NSPoint(x: bounds.minX + 76.21, y: bounds.maxY - 23.36))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 80.82, y: bounds.maxY - 32.56), controlPoint1: NSPoint(x: bounds.minX + 78.72, y: bounds.maxY - 26.4), controlPoint2: NSPoint(x: bounds.minX + 79.74, y: bounds.maxY - 29.45))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 79.83, y: bounds.maxY - 32.56))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 77.58, y: bounds.maxY - 32.56))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 77.17, y: bounds.maxY - 32.25), controlPoint1: NSPoint(x: bounds.minX + 77.35, y: bounds.maxY - 32.56), controlPoint2: NSPoint(x: bounds.minX + 77.23, y: bounds.maxY - 32.5))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 76.74, y: bounds.maxY - 30.82), controlPoint1: NSPoint(x: bounds.minX + 77.06, y: bounds.maxY - 31.77), controlPoint2: NSPoint(x: bounds.minX + 76.91, y: bounds.maxY - 31.28))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 76.42, y: bounds.maxY - 30.58), controlPoint1: NSPoint(x: bounds.minX + 76.71, y: bounds.maxY - 30.7), controlPoint2: NSPoint(x: bounds.minX + 76.53, y: bounds.maxY - 30.58))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 74.05, y: bounds.maxY - 30.55), controlPoint1: NSPoint(x: bounds.minX + 75.63, y: bounds.maxY - 30.55), controlPoint2: NSPoint(x: bounds.minX + 74.84, y: bounds.maxY - 30.58))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 73.73, y: bounds.maxY - 30.82), controlPoint1: NSPoint(x: bounds.minX + 73.85, y: bounds.maxY - 30.55), controlPoint2: NSPoint(x: bounds.minX + 73.76, y: bounds.maxY - 30.61))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 73.33, y: bounds.maxY - 32.29), controlPoint1: NSPoint(x: bounds.minX + 73.62, y: bounds.maxY - 31.31), controlPoint2: NSPoint(x: bounds.minX + 73.47, y: bounds.maxY - 31.8))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 73.09, y: bounds.maxY - 32.53), controlPoint1: NSPoint(x: bounds.minX + 73.3, y: bounds.maxY - 32.38), controlPoint2: NSPoint(x: bounds.minX + 73.18, y: bounds.maxY - 32.53))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 69.88, y: bounds.maxY - 32.59), controlPoint1: NSPoint(x: bounds.minX + 72.04, y: bounds.maxY - 32.59), controlPoint2: NSPoint(x: bounds.minX + 70.99, y: bounds.maxY - 32.59))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 69.88, y: bounds.maxY - 32.59))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 69.88, y: bounds.maxY - 32.59))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 74.29, y: bounds.maxY - 28.35))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 76.24, y: bounds.maxY - 28.35))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 75.31, y: bounds.maxY - 25.43), controlPoint1: NSPoint(x: bounds.minX + 75.92, y: bounds.maxY - 27.35), controlPoint2: NSPoint(x: bounds.minX + 75.63, y: bounds.maxY - 26.4))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 75.22, y: bounds.maxY - 25.43))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 74.29, y: bounds.maxY - 28.35), controlPoint1: NSPoint(x: bounds.minX + 74.9, y: bounds.maxY - 26.37), controlPoint2: NSPoint(x: bounds.minX + 74.61, y: bounds.maxY - 27.35))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 74.29, y: bounds.maxY - 28.35))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 142.33, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 139.41, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 139.41, y: bounds.maxY - 31.52))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 139.29, y: bounds.maxY - 31.55), controlPoint1: NSPoint(x: bounds.minX + 139.35, y: bounds.maxY - 31.55), controlPoint2: NSPoint(x: bounds.minX + 139.32, y: bounds.maxY - 31.55))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 137.02, y: bounds.maxY - 32.8), controlPoint1: NSPoint(x: bounds.minX + 138.83, y: bounds.maxY - 32.56), controlPoint2: NSPoint(x: bounds.minX + 138.01, y: bounds.maxY - 32.86))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 134.77, y: bounds.maxY - 31.28), controlPoint1: NSPoint(x: bounds.minX + 136, y: bounds.maxY - 32.74), controlPoint2: NSPoint(x: bounds.minX + 135.21, y: bounds.maxY - 32.25))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 134.66, y: bounds.maxY - 27.32), controlPoint1: NSPoint(x: bounds.minX + 134.22, y: bounds.maxY - 30), controlPoint2: NSPoint(x: bounds.minX + 134.19, y: bounds.maxY - 28.66))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 139.15, y: bounds.maxY - 26.62), controlPoint1: NSPoint(x: bounds.minX + 135.36, y: bounds.maxY - 25.25), controlPoint2: NSPoint(x: bounds.minX + 138.13, y: bounds.maxY - 25.06))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 139.15, y: bounds.maxY - 22.75))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 142.33, y: bounds.maxY - 22.75))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 142.33, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 142.33, y: bounds.maxY - 32.62))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 139.32, y: bounds.maxY - 29.12))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 139.12, y: bounds.maxY - 28.08), controlPoint1: NSPoint(x: bounds.minX + 139.26, y: bounds.maxY - 28.78), controlPoint2: NSPoint(x: bounds.minX + 139.21, y: bounds.maxY - 28.41))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 138.45, y: bounds.maxY - 27.62), controlPoint1: NSPoint(x: bounds.minX + 139.03, y: bounds.maxY - 27.77), controlPoint2: NSPoint(x: bounds.minX + 138.77, y: bounds.maxY - 27.62))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 137.81, y: bounds.maxY - 28.05), controlPoint1: NSPoint(x: bounds.minX + 138.16, y: bounds.maxY - 27.62), controlPoint2: NSPoint(x: bounds.minX + 137.92, y: bounds.maxY - 27.77))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 137.81, y: bounds.maxY - 30.09), controlPoint1: NSPoint(x: bounds.minX + 137.57, y: bounds.maxY - 28.72), controlPoint2: NSPoint(x: bounds.minX + 137.57, y: bounds.maxY - 29.42))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 138.48, y: bounds.maxY - 30.55), controlPoint1: NSPoint(x: bounds.minX + 137.92, y: bounds.maxY - 30.4), controlPoint2: NSPoint(x: bounds.minX + 138.16, y: bounds.maxY - 30.55))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 139.12, y: bounds.maxY - 30.06), controlPoint1: NSPoint(x: bounds.minX + 138.8, y: bounds.maxY - 30.55), controlPoint2: NSPoint(x: bounds.minX + 139.03, y: bounds.maxY - 30.37))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 139.32, y: bounds.maxY - 29.12), controlPoint1: NSPoint(x: bounds.minX + 139.23, y: bounds.maxY - 29.79), controlPoint2: NSPoint(x: bounds.minX + 139.26, y: bounds.maxY - 29.45))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 139.32, y: bounds.maxY - 29.12))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 28.18))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 129.63, y: bounds.maxY - 27.32), controlPoint1: NSPoint(x: bounds.minX + 130.42, y: bounds.maxY - 27.69), controlPoint2: NSPoint(x: bounds.minX + 130.19, y: bounds.maxY - 27.41))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 127.04, y: bounds.maxY - 27.66), controlPoint1: NSPoint(x: bounds.minX + 128.73, y: bounds.maxY - 27.14), controlPoint2: NSPoint(x: bounds.minX + 127.88, y: bounds.maxY - 27.29))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 126.72, y: bounds.maxY - 27.78), controlPoint1: NSPoint(x: bounds.minX + 126.92, y: bounds.maxY - 27.69), controlPoint2: NSPoint(x: bounds.minX + 126.83, y: bounds.maxY - 27.75))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 126.63, y: bounds.maxY - 27.75), controlPoint1: NSPoint(x: bounds.minX + 126.69, y: bounds.maxY - 27.78), controlPoint2: NSPoint(x: bounds.minX + 126.66, y: bounds.maxY - 27.78))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 126.63, y: bounds.maxY - 26.1))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 126.83, y: bounds.maxY - 25.86), controlPoint1: NSPoint(x: bounds.minX + 126.63, y: bounds.maxY - 26.01), controlPoint2: NSPoint(x: bounds.minX + 126.75, y: bounds.maxY - 25.89))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 131.62, y: bounds.maxY - 25.83), controlPoint1: NSPoint(x: bounds.minX + 128.44, y: bounds.maxY - 25.4), controlPoint2: NSPoint(x: bounds.minX + 130.04, y: bounds.maxY - 25.34))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 133.4, y: bounds.maxY - 28.27), controlPoint1: NSPoint(x: bounds.minX + 132.78, y: bounds.maxY - 26.16), controlPoint2: NSPoint(x: bounds.minX + 133.37, y: bounds.maxY - 26.99))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 133.4, y: bounds.maxY - 32.53), controlPoint1: NSPoint(x: bounds.minX + 133.42, y: bounds.maxY - 29.67), controlPoint2: NSPoint(x: bounds.minX + 133.4, y: bounds.maxY - 31.1))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.45, y: bounds.maxY - 32.53))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.45, y: bounds.maxY - 31.68))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.36, y: bounds.maxY - 31.68))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 127.33, y: bounds.maxY - 32.56), controlPoint1: NSPoint(x: bounds.minX + 129.58, y: bounds.maxY - 32.75), controlPoint2: NSPoint(x: bounds.minX + 128.5, y: bounds.maxY - 32.87))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 125.9, y: bounds.maxY - 31.01), controlPoint1: NSPoint(x: bounds.minX + 126.57, y: bounds.maxY - 32.38), controlPoint2: NSPoint(x: bounds.minX + 125.99, y: bounds.maxY - 31.89))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 126.89, y: bounds.maxY - 28.66), controlPoint1: NSPoint(x: bounds.minX + 125.78, y: bounds.maxY - 30.03), controlPoint2: NSPoint(x: bounds.minX + 126.02, y: bounds.maxY - 29.21))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 128.88, y: bounds.maxY - 28.15), controlPoint1: NSPoint(x: bounds.minX + 127.5, y: bounds.maxY - 28.3), controlPoint2: NSPoint(x: bounds.minX + 128.18, y: bounds.maxY - 28.18))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 28.18), controlPoint1: NSPoint(x: bounds.minX + 129.4, y: bounds.maxY - 28.18), controlPoint2: NSPoint(x: bounds.minX + 129.93, y: bounds.maxY - 28.18))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 28.18))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 28.18))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 29.49))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 129.14, y: bounds.maxY - 29.73), controlPoint1: NSPoint(x: bounds.minX + 130.01, y: bounds.maxY - 29.58), controlPoint2: NSPoint(x: bounds.minX + 129.55, y: bounds.maxY - 29.61))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 128.76, y: bounds.maxY - 30.49), controlPoint1: NSPoint(x: bounds.minX + 128.82, y: bounds.maxY - 29.82), controlPoint2: NSPoint(x: bounds.minX + 128.73, y: bounds.maxY - 30.13))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 129.31, y: bounds.maxY - 31.01), controlPoint1: NSPoint(x: bounds.minX + 128.82, y: bounds.maxY - 30.83), controlPoint2: NSPoint(x: bounds.minX + 129.02, y: bounds.maxY - 30.95))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 29.49), controlPoint1: NSPoint(x: bounds.minX + 130.07, y: bounds.maxY - 31.07), controlPoint2: NSPoint(x: bounds.minX + 130.57, y: bounds.maxY - 30.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 29.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 130.48, y: bounds.maxY - 29.49))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 101.95, y: bounds.maxY - 29.86))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 97.55, y: bounds.maxY - 29.86))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 98.25, y: bounds.maxY - 30.8), controlPoint1: NSPoint(x: bounds.minX + 97.52, y: bounds.maxY - 30.34), controlPoint2: NSPoint(x: bounds.minX + 97.75, y: bounds.maxY - 30.65))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 100.67, y: bounds.maxY - 30.77), controlPoint1: NSPoint(x: bounds.minX + 99.06, y: bounds.maxY - 31.04), controlPoint2: NSPoint(x: bounds.minX + 99.88, y: bounds.maxY - 30.95))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 101.4, y: bounds.maxY - 30.56), controlPoint1: NSPoint(x: bounds.minX + 100.9, y: bounds.maxY - 30.71), controlPoint2: NSPoint(x: bounds.minX + 101.11, y: bounds.maxY - 30.65))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 101.4, y: bounds.maxY - 32.17))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 101.22, y: bounds.maxY - 32.35), controlPoint1: NSPoint(x: bounds.minX + 101.4, y: bounds.maxY - 32.23), controlPoint2: NSPoint(x: bounds.minX + 101.28, y: bounds.maxY - 32.32))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 96.73, y: bounds.maxY - 32.45), controlPoint1: NSPoint(x: bounds.minX + 99.73, y: bounds.maxY - 32.72), controlPoint2: NSPoint(x: bounds.minX + 98.22, y: bounds.maxY - 32.87))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 94.4, y: bounds.maxY - 29.37), controlPoint1: NSPoint(x: bounds.minX + 95.3, y: bounds.maxY - 32.02), controlPoint2: NSPoint(x: bounds.minX + 94.49, y: bounds.maxY - 30.92))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 94.43, y: bounds.maxY - 28.33), controlPoint1: NSPoint(x: bounds.minX + 94.37, y: bounds.maxY - 29.03), controlPoint2: NSPoint(x: bounds.minX + 94.37, y: bounds.maxY - 28.67))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 96.32, y: bounds.maxY - 25.83), controlPoint1: NSPoint(x: bounds.minX + 94.57, y: bounds.maxY - 27.11), controlPoint2: NSPoint(x: bounds.minX + 95.21, y: bounds.maxY - 26.26))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 99.38, y: bounds.maxY - 25.59), controlPoint1: NSPoint(x: bounds.minX + 97.31, y: bounds.maxY - 25.47), controlPoint2: NSPoint(x: bounds.minX + 98.36, y: bounds.maxY - 25.41))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 101.66, y: bounds.maxY - 27.78), controlPoint1: NSPoint(x: bounds.minX + 100.58, y: bounds.maxY - 25.8), controlPoint2: NSPoint(x: bounds.minX + 101.37, y: bounds.maxY - 26.56))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 101.95, y: bounds.maxY - 29.86), controlPoint1: NSPoint(x: bounds.minX + 101.83, y: bounds.maxY - 28.42), controlPoint2: NSPoint(x: bounds.minX + 101.86, y: bounds.maxY - 29.12))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 101.95, y: bounds.maxY - 29.86))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 101.95, y: bounds.maxY - 29.86))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 99.15, y: bounds.maxY - 28.39))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 98.74, y: bounds.maxY - 27.17), controlPoint1: NSPoint(x: bounds.minX + 99.12, y: bounds.maxY - 27.94), controlPoint2: NSPoint(x: bounds.minX + 99.12, y: bounds.maxY - 27.48))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 97.93, y: bounds.maxY - 27.17), controlPoint1: NSPoint(x: bounds.minX + 98.48, y: bounds.maxY - 26.96), controlPoint2: NSPoint(x: bounds.minX + 98.19, y: bounds.maxY - 26.99))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 97.49, y: bounds.maxY - 28.39), controlPoint1: NSPoint(x: bounds.minX + 97.55, y: bounds.maxY - 27.48), controlPoint2: NSPoint(x: bounds.minX + 97.49, y: bounds.maxY - 27.91))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 99.15, y: bounds.maxY - 28.39))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 99.15, y: bounds.maxY - 28.39))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 99.15, y: bounds.maxY - 28.39))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 150.82, y: bounds.maxY - 29.89))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 146.51, y: bounds.maxY - 29.89))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 147.29, y: bounds.maxY - 30.84), controlPoint1: NSPoint(x: bounds.minX + 146.48, y: bounds.maxY - 30.38), controlPoint2: NSPoint(x: bounds.minX + 146.74, y: bounds.maxY - 30.78))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 149.04, y: bounds.maxY - 30.9), controlPoint1: NSPoint(x: bounds.minX + 147.88, y: bounds.maxY - 30.93), controlPoint2: NSPoint(x: bounds.minX + 148.46, y: bounds.maxY - 30.93))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 150.36, y: bounds.maxY - 30.62), controlPoint1: NSPoint(x: bounds.minX + 149.48, y: bounds.maxY - 30.87), controlPoint2: NSPoint(x: bounds.minX + 149.89, y: bounds.maxY - 30.72))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 150.36, y: bounds.maxY - 32.33))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 145.34, y: bounds.maxY - 32.33), controlPoint1: NSPoint(x: bounds.minX + 148.69, y: bounds.maxY - 32.7), controlPoint2: NSPoint(x: bounds.minX + 147, y: bounds.maxY - 32.97))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 143.39, y: bounds.maxY - 29.53), controlPoint1: NSPoint(x: bounds.minX + 144.12, y: bounds.maxY - 31.87), controlPoint2: NSPoint(x: bounds.minX + 143.5, y: bounds.maxY - 30.87))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 143.45, y: bounds.maxY - 28.12), controlPoint1: NSPoint(x: bounds.minX + 143.36, y: bounds.maxY - 29.07), controlPoint2: NSPoint(x: bounds.minX + 143.36, y: bounds.maxY - 28.58))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 145.08, y: bounds.maxY - 25.96), controlPoint1: NSPoint(x: bounds.minX + 143.59, y: bounds.maxY - 27.09), controlPoint2: NSPoint(x: bounds.minX + 144.15, y: bounds.maxY - 26.36))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 148.72, y: bounds.maxY - 25.69), controlPoint1: NSPoint(x: bounds.minX + 146.24, y: bounds.maxY - 25.44), controlPoint2: NSPoint(x: bounds.minX + 147.47, y: bounds.maxY - 25.35))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 150.85, y: bounds.maxY - 28.67), controlPoint1: NSPoint(x: bounds.minX + 149.98, y: bounds.maxY - 26.02), controlPoint2: NSPoint(x: bounds.minX + 150.71, y: bounds.maxY - 27.09))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 150.82, y: bounds.maxY - 29.89), controlPoint1: NSPoint(x: bounds.minX + 150.85, y: bounds.maxY - 29.07), controlPoint2: NSPoint(x: bounds.minX + 150.82, y: bounds.maxY - 29.47))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 150.82, y: bounds.maxY - 29.89))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 150.82, y: bounds.maxY - 29.89))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 146.45, y: bounds.maxY - 28.43))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 148.11, y: bounds.maxY - 28.43))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 147.64, y: bounds.maxY - 27.21), controlPoint1: NSPoint(x: bounds.minX + 148.08, y: bounds.maxY - 27.94), controlPoint2: NSPoint(x: bounds.minX + 148.11, y: bounds.maxY - 27.42))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 146.86, y: bounds.maxY - 27.24), controlPoint1: NSPoint(x: bounds.minX + 147.44, y: bounds.maxY - 27.09), controlPoint2: NSPoint(x: bounds.minX + 147.06, y: bounds.maxY - 27.12))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 146.45, y: bounds.maxY - 28.43), controlPoint1: NSPoint(x: bounds.minX + 146.45, y: bounds.maxY - 27.48), controlPoint2: NSPoint(x: bounds.minX + 146.42, y: bounds.maxY - 27.97))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 146.45, y: bounds.maxY - 28.43))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 25.64))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 119.05, y: bounds.maxY - 25.64))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 119.05, y: bounds.maxY - 27.59))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 117.65, y: bounds.maxY - 27.59))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 117.65, y: bounds.maxY - 29.82), controlPoint1: NSPoint(x: bounds.minX + 117.65, y: bounds.maxY - 28.38), controlPoint2: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 29.09))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 118.38, y: bounds.maxY - 30.46), controlPoint1: NSPoint(x: bounds.minX + 117.68, y: bounds.maxY - 30.24), controlPoint2: NSPoint(x: bounds.minX + 117.97, y: bounds.maxY - 30.46))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 119.05, y: bounds.maxY - 30.4), controlPoint1: NSPoint(x: bounds.minX + 118.58, y: bounds.maxY - 30.46), controlPoint2: NSPoint(x: bounds.minX + 118.79, y: bounds.maxY - 30.4))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 119.05, y: bounds.maxY - 32.19))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 118.87, y: bounds.maxY - 32.38), controlPoint1: NSPoint(x: bounds.minX + 119.05, y: bounds.maxY - 32.25), controlPoint2: NSPoint(x: bounds.minX + 118.96, y: bounds.maxY - 32.38))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 116.22, y: bounds.maxY - 32.62), controlPoint1: NSPoint(x: bounds.minX + 118, y: bounds.maxY - 32.65), controlPoint2: NSPoint(x: bounds.minX + 117.12, y: bounds.maxY - 32.77))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 114.5, y: bounds.maxY - 30.76), controlPoint1: NSPoint(x: bounds.minX + 115.23, y: bounds.maxY - 32.47), controlPoint2: NSPoint(x: bounds.minX + 114.62, y: bounds.maxY - 31.83))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 28.17), controlPoint1: NSPoint(x: bounds.minX + 114.41, y: bounds.maxY - 29.91), controlPoint2: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 29.02))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 27.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 113.33, y: bounds.maxY - 27.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 113.33, y: bounds.maxY - 25.67))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 25.67))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 24.33))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 114.65, y: bounds.maxY - 24), controlPoint1: NSPoint(x: bounds.minX + 114.44, y: bounds.maxY - 24.21), controlPoint2: NSPoint(x: bounds.minX + 114.56, y: bounds.maxY - 24.03))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 117.36, y: bounds.maxY - 23.11), controlPoint1: NSPoint(x: bounds.minX + 115.55, y: bounds.maxY - 23.69), controlPoint2: NSPoint(x: bounds.minX + 116.45, y: bounds.maxY - 23.42))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 23.05), controlPoint1: NSPoint(x: bounds.minX + 117.42, y: bounds.maxY - 23.08), controlPoint2: NSPoint(x: bounds.minX + 117.5, y: bounds.maxY - 23.08))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 25.64))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 25.64))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 117.62, y: bounds.maxY - 25.64))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 108.32, y: bounds.maxY - 25.54))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 108.35, y: bounds.maxY - 25.78), controlPoint1: NSPoint(x: bounds.minX + 108.32, y: bounds.maxY - 25.63), controlPoint2: NSPoint(x: bounds.minX + 108.35, y: bounds.maxY - 25.69))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 108.35, y: bounds.maxY - 28.28))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 108, y: bounds.maxY - 28.22), controlPoint1: NSPoint(x: bounds.minX + 108.2, y: bounds.maxY - 28.25), controlPoint2: NSPoint(x: bounds.minX + 108.11, y: bounds.maxY - 28.25))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 105.99, y: bounds.maxY - 30.02), controlPoint1: NSPoint(x: bounds.minX + 106.89, y: bounds.maxY - 28.07), controlPoint2: NSPoint(x: bounds.minX + 106.01, y: bounds.maxY - 28.83))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 105.99, y: bounds.maxY - 32.09))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 105.99, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 102.84, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 102.84, y: bounds.maxY - 25.69))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 105.78, y: bounds.maxY - 25.69))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 105.78, y: bounds.maxY - 27.06))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 108.32, y: bounds.maxY - 25.54), controlPoint1: NSPoint(x: bounds.minX + 106.36, y: bounds.maxY - 26), controlPoint2: NSPoint(x: bounds.minX + 107.06, y: bounds.maxY - 25.29))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 108.32, y: bounds.maxY - 25.54))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 108.32, y: bounds.maxY - 25.54))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 120.04, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 120.04, y: bounds.maxY - 25.67))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 122.96, y: bounds.maxY - 25.67))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 122.96, y: bounds.maxY - 27.04))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 123.02, y: bounds.maxY - 27.1), controlPoint1: NSPoint(x: bounds.minX + 122.99, y: bounds.maxY - 27.07), controlPoint2: NSPoint(x: bounds.minX + 123.02, y: bounds.maxY - 27.07))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 125.49, y: bounds.maxY - 25.55), controlPoint1: NSPoint(x: bounds.minX + 123.51, y: bounds.maxY - 26.03), controlPoint2: NSPoint(x: bounds.minX + 124.21, y: bounds.maxY - 25.27))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 125.49, y: bounds.maxY - 28.26))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 125.17, y: bounds.maxY - 28.2), controlPoint1: NSPoint(x: bounds.minX + 125.38, y: bounds.maxY - 28.23), controlPoint2: NSPoint(x: bounds.minX + 125.26, y: bounds.maxY - 28.23))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 29.99), controlPoint1: NSPoint(x: bounds.minX + 124.06, y: bounds.maxY - 28.04), controlPoint2: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 28.84))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 32.13))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 32.49))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 123.19, y: bounds.maxY - 32.49))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 109.54, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 109.54, y: bounds.maxY - 25.79))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 25.79))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 32.62))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 32.62))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 109.54, y: bounds.maxY - 24.97))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 109.54, y: bounds.maxY - 22.75))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 22.75))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 112.66, y: bounds.maxY - 24.97))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 109.54, y: bounds.maxY - 24.97))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 40.15, y: bounds.maxY - 16.8))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 64.39, y: bounds.maxY - 16.8))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 64.39, y: bounds.maxY - 38.3))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 40.15, y: bounds.maxY - 38.3))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 40.15, y: bounds.maxY - 16.8))
        tdBankLogoPath.close()
        tdBankLogoPath.move(to: NSPoint(x: bounds.minX + 53.32, y: bounds.maxY - 31.75))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 53.32, y: bounds.maxY - 23.5))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 50.37, y: bounds.maxY - 23.5))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 50.37, y: bounds.maxY - 33.73))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 57.47, y: bounds.maxY - 33.73), controlPoint1: NSPoint(x: bounds.minX + 50.37, y: bounds.maxY - 33.73), controlPoint2: NSPoint(x: bounds.minX + 55.23, y: bounds.maxY - 33.81))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 61.39, y: bounds.maxY - 30.58), controlPoint1: NSPoint(x: bounds.minX + 59.5, y: bounds.maxY - 33.67), controlPoint2: NSPoint(x: bounds.minX + 60.86, y: bounds.maxY - 32.5))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 61.48, y: bounds.maxY - 24.32), controlPoint1: NSPoint(x: bounds.minX + 61.95, y: bounds.maxY - 28.51), controlPoint2: NSPoint(x: bounds.minX + 61.98, y: bounds.maxY - 26.41))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 58.92, y: bounds.maxY - 21.4), controlPoint1: NSPoint(x: bounds.minX + 61.15, y: bounds.maxY - 22.95), controlPoint2: NSPoint(x: bounds.minX + 60.36, y: bounds.maxY - 21.84))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 56.74, y: bounds.maxY - 21.08), controlPoint1: NSPoint(x: bounds.minX + 58.21, y: bounds.maxY - 21.2), controlPoint2: NSPoint(x: bounds.minX + 57.47, y: bounds.maxY - 21.08))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 42.6, y: bounds.maxY - 21.08), controlPoint1: NSPoint(x: bounds.minX + 52.2, y: bounds.maxY - 21.05), controlPoint2: NSPoint(x: bounds.minX + 42.6, y: bounds.maxY - 21.08))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 42.6, y: bounds.maxY - 22.95))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 46.75, y: bounds.maxY - 22.95))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 46.75, y: bounds.maxY - 23.41))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 46.75, y: bounds.maxY - 33.73))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 49.64, y: bounds.maxY - 33.73))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 49.64, y: bounds.maxY - 22.95))
        tdBankLogoPath.line(to: NSPoint(x: bounds.minX + 55.91, y: bounds.maxY - 22.95))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 58.39, y: bounds.maxY - 24.87), controlPoint1: NSPoint(x: bounds.minX + 57.32, y: bounds.maxY - 22.95), controlPoint2: NSPoint(x: bounds.minX + 58.06, y: bounds.maxY - 23.53))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 58.56, y: bounds.maxY - 28.66), controlPoint1: NSPoint(x: bounds.minX + 58.71, y: bounds.maxY - 26.12), controlPoint2: NSPoint(x: bounds.minX + 58.68, y: bounds.maxY - 27.4))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 58.09, y: bounds.maxY - 30.64), controlPoint1: NSPoint(x: bounds.minX + 58.5, y: bounds.maxY - 29.33), controlPoint2: NSPoint(x: bounds.minX + 58.3, y: bounds.maxY - 30))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 56.68, y: bounds.maxY - 31.77), controlPoint1: NSPoint(x: bounds.minX + 57.85, y: bounds.maxY - 31.25), controlPoint2: NSPoint(x: bounds.minX + 57.35, y: bounds.maxY - 31.69))
        tdBankLogoPath.curve(to: NSPoint(x: bounds.minX + 53.32, y: bounds.maxY - 31.75), controlPoint1: NSPoint(x: bounds.minX + 55.44, y: bounds.maxY - 31.75), controlPoint2: NSPoint(x: bounds.minX + 53.32, y: bounds.maxY - 31.75))
        tdBankLogoPath.close()
        tdBankLogoPath.windingRule = .evenOddWindingRule
        logoWhite.setFill()
        tdBankLogoPath.fill()
    }
